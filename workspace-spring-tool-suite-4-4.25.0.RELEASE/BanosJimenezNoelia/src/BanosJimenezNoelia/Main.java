	...
	public static void main(String[] args) {
		...
		do {
			...
			if (fila >= 3 && fila <= 20 && fila == columna) {
				...
				asientos = rellenarAsientos(fila, columna);
...
///////////////////////////////////////////////////////////////////////////
	// funciones
	// me hubiera gustado poner los asientos en este apartado pero ya no daba tiempo
	@SuppressWarnings("unused")
	private static void mostrar(int matriz[][], int total) {
		// Mostramos la matriz
