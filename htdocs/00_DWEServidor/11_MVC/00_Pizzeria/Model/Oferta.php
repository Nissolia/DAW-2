<?php require_once 'PizzeriaDB.php';
class Oferta
{
    private $id;
    private $titulo;
    ...
    public function insert()
    {
        ...
        $insercion = "INSERT INTO oferta (titulo, imagen, descripcion) VALUES ('$this-
>titulo', '$this->imagen', '$this->descripcion')";
    ...
    {
        $conexion = PizzeriaDB::connectDB();
        $seleccion = "SELECT * FROM oferta WHERE id=\"" . $id . "\"";
        $consulta = $conexion->query($seleccion);
