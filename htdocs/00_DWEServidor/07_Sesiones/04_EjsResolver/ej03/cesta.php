        ...
        ?>
            ...
            ?>
                <tr>
                    ...
                    <td class="producto_tabla"><?= ($producto['cantidad']) ?></td>
                    <td class="producto_tabla"><img src="<?= ($producto['imagen']) ?>" alt="<?= ($producto['nombre']) ?>" width="50"></td>
                    <td class="producto_tabla"><?= $producto['precio'] * $producto['cantidad'] ?>€</td>
            ...
            <tr>
                ...
                <td class="producto_tabla" colspan="2"><strong><?= $totalPrecio ?>€</strong></td>
                <td class="producto_tabla">
