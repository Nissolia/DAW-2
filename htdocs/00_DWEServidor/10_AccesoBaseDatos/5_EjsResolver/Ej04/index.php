...
if (isset($_REQUEST['accion'])) {
    if ($_REQUEST['accion'] === 'Siguiente' && $_SESSION['paginaActual'] < $_SESSION['paginasTotales']) {
        $_SESSION['paginaActual']++;
    } elseif ($_REQUEST['accion'] === 'Anterior' && $_SESSION['paginaActual'] > 1) {
        $_SESSION['paginaActual']--;
    } elseif ($_REQUEST['accion'] === 'Primera') {
        $_SESSION['paginaActual'] = 1;
    } elseif ($_REQUEST['accion'] === 'Última') {
        $_SESSION['paginaActual'] = $_SESSION['paginasTotales'];
    }
}

// Calcular el offset para la consulta SQL, para deifnir los elementos en las páginas
